...
public  class TDA_Grafos_Estatico : MonoBehaviour
{
    public interface GrafoTDA
    {
        ...
        TDA_Conjunto.ConjuntoTDA Vertices();
    ...
    public class GrafoMA : GrafoTDA
    {
        ...
        public TDA_Conjunto.ConjuntoTDA Vertices()
        {
            TDA_Conjunto.ConjuntoTDA Vert = new TDA_Conjunto.ConjuntoLD();
